                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="alert hidden importPricesSuccess alert-success alert-dismissible" role="alert">
                                ...
                                The pstocks have been succesfully updated.</b>
                            </div>
                        <form id="importPrices" method="post" action='/ajax/updatePrices' enctype="multipart/form-data" class="">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <button id="submitImportPrices" class="btn btn-lg btn-block btn-success waves-effect" type="submit">Import Stocks</button>
                                </div>
                            </div>
                        </form>
                    </div>
