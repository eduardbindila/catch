                        ...
                        },
                        {
                            ...
                            action: function ( e, dt, button, config ) {
                                ...
                                for ( i = 0; i < selection.length; i++) {
                                    ...
                                    selectedItems.push(thisProduct);
                                }
             ...
             table[index] = $('#quote-'+val['id']).DataTable({
                ...
                { 
                    ...
                    { 
                        ...
                        "render" : function(data, type, row, meta) {
                            ...
                            return '<div class="form-group"><div class="form-line"><input class="form-control quote-input" data-type="discount" data-index="'+index+'" name="discount" data-row="'+meta.row+'" data-col="'+meta.col+'" data-item="'+row.quote_item_id+'" placeholder="Discount" value="'+row.discount+'" type="number" mi></div></div>'
                          }
                    },
                    {
                        "data": "unit_price", 
                      ...
                      "render" : function(data, type, row, meta) {
                            ...
                            return '<div class="form-group"><div class="form-line"><input class="form-control unit-price quote-input" data-type="unitPrice" data-index="'+index+'" placeholder="Unit Price" data-row="'+meta.row+'" data-col="'+meta.col+'" data-item="'+row.quote_item_id+'" value="'+data+'" type="number" mi></div></div>'
                      }
                    },
                ...
                "drawCallback": function(settings, json) {
                    if(quoteStatus[val['id']] == 4) {
                       ...
                       $('#quote-'+val['id']).find('input, textarea, button, select').attr('disabled','disabled');
                    } 
                  },
...
$(function() {
    ...
    if($('.dropzone').length) {
        var myDropzone = new Dropzone(".dropzone", {
            url: "/ajax/uploadCustomProductImage",
            paramName: "file",
            maxFilesize: 2,
            maxFiles: 1,
            acceptedFiles: "image/*",
...
function updateStatus(quoteStatus){
    ...
    $.each($('.status-wrapper'), function (i, item) {
        ...
        statusButton.removeClass('btn-default').addClass('btn-success');
    });
}