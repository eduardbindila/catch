                    ...
                    <form id="editQuote" method="post" action='' enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="text-center m-t-10">
                                <div class="preloader pl-size-xs hidden edit-quote-preloader">
                ...
                <div class="modal-body">
                    <form id="sendQuoteForm" method="post" action='' enctype="multipart/form-data">
                        <p><b>From:</b> office@icatch.ro<br />
                            <b>To:<span class="clientToName"></span></b> <input id="clientEmail" type="text" class="form-control" name="clientEmail" placeholder="">
                        </p>
                        <p>Dear client, <br /><br />
