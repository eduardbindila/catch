...
$conn = $QueryBuilder->dbConnection();
	...
	$projectsQuery = $QueryBuilder->select(
		...
		$options = array(
			...
			"columns" => "vendor_invoice_items.*, vendor_invoice_item_types.name as type_name, products.saga_quantity, (
			...
			"innerJoin" => "products on vendor_invoice_items.product_id = products.id left join vendor_invoice_item_types on vendor_invoice_items.type = vendor_invoice_item_types.id",
