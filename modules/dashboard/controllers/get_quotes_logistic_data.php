...
$query = "SELECT 
	...
	sub.reserved_stock + sub.ordered_quantity as quote_fulfilled_quantity,
	sub.in_transit_quantity, 
	sub.received_quantity, 
	sub.invoiced_quantity, 
	sub.date_added,
       CASE
           WHEN (sub.in_transit_quantity = 0)
                AND (sub.received_quantity = 0)
                AND (sub.invoiced_quantity = 0)  
                AND (sub.quantity > 0)THEN
               CASE
