...
$LoadHTMLArtefacts->setScript($_WMPATH['IMPORT_ELEMENTS_VIEWS'].'import-scrapping.js');
...
include($_MPATH['IMPORT_ELEMENTS_CONTROLLERS'].'import_scrapping_controller.php');
