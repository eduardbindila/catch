...
$LoadHTMLArtefacts->setLink($_WPATH['COMMON_INTERFACE'].'plugins/multi-select/css/multi-select.css');
...
$LoadHTMLArtefacts->setScript($_WPATH['COMMON_INTERFACE'].'plugins/multi-select/js/jquery.multi-select.js');
